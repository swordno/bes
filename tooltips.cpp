...
VOID InitToolTipsRus( TCHAR (*str)[ 64 ] )
{
	wcscpy_s( str[ 0 ], 64, S_TOOLTIP_RUS0 );
	wcscpy_s( str[ 1 ], 64, S_TOOLTIP_RUS1 );
	wcscpy_s( str[ 2 ], 64, S_TOOLTIP_RUS2 );
	wcscpy_s( str[ 3 ], 64, S_TOOLTIP_RUS3 );
}
...
//---
	...
	ModifyMenu( hMenu, IDM_RUSSIAN, MF_STRING | MF_BYCOMMAND, IDM_RUSSIAN, FIN_31 );
...
VOID InitMenuRus( const HWND hWnd )
{
	HMENU hMenu = GetMenu( hWnd );
	...
	wcscpy_s( str[0], 256, S_MENU_RUS0 );
	wcscpy_s( str[1], 256, S_MENU_RUS1 );
	wcscpy_s( str[2], 256, S_MENU_RUS2 );
	wcscpy_s( str[3], 256, S_MENU_RUS3 );
	...
	wcscpy_s( str[0], 256, RUS_0 );
	wcscpy_s( str[1], 256, RUS_1 );
	wcscpy_s( str[2], 256, RUS_2 );
	wcscpy_s( str[3], 256, RUS_3 );
	wcscpy_s( str[4], 256, RUS_4 );
	//MultiByteToWideChar( CP_UTF8, MB_CUTE, RUS_5, -1, str[ 5 ], 256 );
	wcscpy_s( str[6], 256, RUS_6 );
	wcscpy_s( str[7], 256, RUS_7 );
	wcscpy_s( str[8], 256, RUS_8 );
	wcscpy_s( str[9], 256, RUS_9 );
	wcscpy_s( str[10], 256, RUS_10 );
	//MultiByteToWideChar( CP_UTF8, MB_CUTE, RUS_11, -1, str[ 11 ], 256 );
	//MultiByteToWideChar( CP_UTF8, MB_CUTE, RUS_12, -1, str[ 12 ], 256 );
	//MultiByteToWideChar( CP_UTF8, MB_CUTE, RUS_13, -1, str[ 13 ], 256 );
	//MultiByteToWideChar( CP_UTF8, MB_CUTE, RUS_14, -1, str[ 14 ], 256 );
	//MultiByteToWideChar( CP_UTF8, MB_CUTE, RUS_15, -1, str[ 15 ], 256 );
	wcscpy_s( str[16], 256, RUS_16 );
	wcscpy_s( str[17], 256, RUS_17 );
	wcscpy_s( str[18], 256, RUS_18 );
	wcscpy_s( str[19], 256, RUS_19 );
	wcscpy_s( str[20], 256, RUS_20 );
	//
	wcscpy_s( str[21], 256, RUS_21 );
	wcscpy_s( str[22], 256, RUS_22 );
	wcscpy_s( str[23], 256, RUS_23 );
	//MultiByteToWideChar( CP_UTF8, MB_CUTE, RUS_24, -1, str[ 24 ], 256 );
	wcscpy_s( str[25], 256, RUS_25 );
	//MultiByteToWideChar( CP_UTF8, MB_CUTE, RUS_26, -1, str[ 26 ], 256 );
	wcscpy_s( str[27], 256, RUS_27 );
	wcscpy_s( str[28], 256, RUS_28 );
	for( int i = 0; i <= 28; i++ )
	{
		if( ! str[ i ][ 0 ] ) continue;
		UINT uMenuId = (UINT) ( IDM_MENU_BASE  +  i );
	...
	wcscpy_s( str[29], 256, RUS_29 );
	//MultiByteToWideChar( CP_UTF8, MB_CUTE, RUS_30, -1, str[ 30 ], 256 );
...
//---
	...
	ModifyMenu( hMenu, IDM_RUSSIAN, MF_STRING | MF_BYCOMMAND, IDM_RUSSIAN, RUS_31 );
...
//---
	...
	ModifyMenu( hMenu, IDM_RUSSIAN, MF_STRING | MF_BYCOMMAND, IDM_RUSSIAN, SPA_31 );
...
//---
	...
	ModifyMenu( hMenu, IDM_RUSSIAN, MF_STRING | MF_BYCOMMAND, IDM_RUSSIAN, FRE_31 );
...
//---
	...
	ModifyMenu( hMenu, IDM_RUSSIAN, MF_STRING | MF_BYCOMMAND, IDM_RUSSIAN, JPN_31 );
...
//---
	...
	ModifyMenu( hMenu, IDM_RUSSIAN, MF_STRING | MF_BYCOMMAND, IDM_RUSSIAN, CHT_31 );
...
//---
	...
	ModifyMenu( hMenu, IDM_RUSSIAN, MF_STRING | MF_BYCOMMAND, IDM_RUSSIAN, CHS_31 );
...
//---
	...
	ModifyMenu( hMenu, IDM_RUSSIAN, MF_STRING | MF_BYCOMMAND, IDM_RUSSIAN, ENG_31 );
