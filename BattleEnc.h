...
# define APP_LONGNAME L"BES \x2014 Battle Encoder Shiras\x00E9 1.8.0-test28"
#else
# define APP_NAME "BES - Battle Encoder Shirase"
# define APP_LONGNAME "BES - Battle Encoder Shirase 1.8.0-test28"
#endif
...
// if CAIO is defineded, foreground window is not limited (experimental)
//#undef CAIO
...
#  define UNICODE
# endif
# define APP_COPYRIGHT L"Copyright \251 2004" L"\x2013" L"2023 mion"
#else
# ifdef UNICODE
#  undef UNICODE
# endif
# define APP_COPYRIGHT "Copyright (c) 2004-2023 mion"
#endif
...
#define IS_RUSSIAN   ( GetLanguage() == LANG_RUSSIAN )
